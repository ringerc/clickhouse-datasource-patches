...
export const Components = {
  ...
  Config: {
    ...
    CustomSettingsConfig: {
      ...
      jwtSourceOption: 'config__custom-settings__jwt-source-option',
      jwtTokenHeaderInput: 'config__custom-settings__jwt-token-header-input',
      jwtClaimPathInput: 'config__custom-settings__jwt-claim-path-input',
      jwtArrayJoinInput: 'config__custom-settings__jwt-array-join-input',
      jwtVerifySelect: 'config__custom-settings__jwt-verify-select',
      jwtJwksUrlInput: 'config__custom-settings__jwt-jwks-url-input',
      jwtIssuerInput: 'config__custom-settings__jwt-issuer-input',
      jwtAudienceInput: 'config__custom-settings__jwt-audience-input',
      jwtInfoBanner: 'config__custom-settings__jwt-info-banner',
    },
    AliasTableConfig: {
